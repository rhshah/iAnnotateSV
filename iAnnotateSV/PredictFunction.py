...
def PredictFunctionForSV(ann1S,ann2S):
    strandmatch1 = ((ann1S.txstrand1 == '+' and ann1S.readstrand1 == 0) or (ann1S.txstrand1 == '-' and ann1S.readstrand1 == 1))
    strandmatch2 = ((ann2S.txstrand2 == '+' and ann2S.readstrand2 == 0) or (ann2S.txstrand2 == '-' and ann2S.readstrand2 == 1))
